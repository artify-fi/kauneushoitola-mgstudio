    ...
    <Grid container direction="column">
      ...
      >
        <Typography
          ...
          variant="h1"
        >
          Www-sisällönhallinta tarkoittaa toimintaa jossa verkkopalvelun
          sisältöjä pyritään hallitsemaan mahdollisimman tarkoituksenmukaisesti.
          Www-sisällönhallinnan käytännön toteutukseen liittyvät olennaisesti
          erilaiset www-sisällönhallintajärjestelmät.
        </Typography>
      </Grid>
        ...
        <Grid item container direction="column" lg style={{ maxWidth: '40em' }}>
          ...
          <Grid item>
            <Typography
              ...
              paragraph
            >
              Artify n kotisivujen kehitysprosessissa "Headless WordPress"
              käsittelee sisällön luomista ja GatsbyJS hoitaa käyttöliittymän.
              Gatsbyn lisääminen on loistava tapa tehostaa modernia
              suorituskykyä, skaalautuvuutta, tietoturvaa ja kehitysnopeuden
              etuja säilyttäen samalla WordPressin tutun
            ...
            <Typography
              ...
              paragraph
            >
              Gatsbyn käyttö yhdessä WordPressin kanssa on hyödyllinen
              siirtymisreitti yrityksille, kuka jo omistavat WordPress
              kotisivuja ja jotka etsivät parempaa tietoturvaa, sivuston
              suorituskykyä tai haluavat julkaista sisältöä automaattisesti
              useilla kanavilla samanaikaisesti..
            </Typography>
            ...
            >
              ...
              kokonaan uutta pinoa, Gatsbyn käyttäminen WordPressin rinnalla on
              tapa tuottaa etuja muuttamatta heidän sisällönmuokkauskokemustaan.
            </Typography>
          </Grid>
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item container justify="space-around" lg>
          <img
            src={ACF}
          ...
          <Link to="/">
            <Typography variant="h6">Katso iso kuva</Typography>
          </Link>
        </Grid>
      </Grid>
        ...
        >
          ...
          >
            <Typography
              ...
              paragraph
            >
              Kun olemme asettuneet parhaalle tielle eteenpäin ja päätämme
              ratkaisusta, jota jatkaa, yksityiskohdat, kuten kustannukset ja
              aikataulu, viimeistellään.
            </Typography>
            <Typography
              variant={matchesSM ? 'body2' : 'body1'}
              align={matchesMD ? 'center' : 'left'}
              ...
              paragraph
            >
              Sitten meidän on aika aloittaa vähimmäiskykyisellä tuotteellasi.
              Se on vain kuvitteellinen termi mallille, joka ei sisällä värejä,
              kuvia tai muita kiillotettuja muotoiluelementtejä, mutta sisältää
              tärkeän asettelurakenteen ja toiminnallisuuden.
            </Typography>
          </Grid>
        </Grid>
        ...
        >
          ...
          <Grid item container alignItems="center">
            <Typography
              ...
              paragraph
            >
              Here’s where we get down to business. Engineering begins after
              your approval on the final designs. We start by scaffolding out
        ...
        >
          ...
          <Grid item container alignItems="center">
            <Typography
              ...
              paragraph
            >
              The moment we’ve all been waiting for. When construction comes to
              a close you’re the first one to know. We’ll give our final
              demonstration to show off your shiny new software in the wild so
              you know exactly how it will look to your users.
            </Typography>
            <Typography
              variant="body1"
              align={matchesMD ? 'center' : undefined}
